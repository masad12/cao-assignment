...
These methods return an [`APIResponse`](https://github.com/masad12/cao-assignment/tree/main/src/ctexaa/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/masad12/cao-assignment/tree/main/src/ctexaa/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/masad12/cao-assignment/issues) with questions, bugs, or suggestions.
